...
export default async function DashboardPage(){
    ...
    return(
        <main className="bg-slate-300 m-5 p-5">
            ...
            </table>
            {
                ...
                <form action={addCar}>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <label className="w-auto block text-gray-700 pr-4" htmlFor="doors">Doors</label>
                        <input type='text' required id="doors" name="doors" placeholder="4" min={0} max={6}
                        className="bg-white border-2 border-gray-200 rounded w-auto p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
                        <input type="checkbox" id="automatic" name="automatic" className="ml-5 mr-2"/><span>Auto</span>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-gray-700 pr-4" htmlFor="largebags">LargeBags</label>
                        <input type='number' required id="largebags" name="largebags" placeholder="2" min={0} max={10}
                        className="bg-white border-2 border-gray-200 rounded w-auto p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
                        <label className="w-auto block text-gray-700 pr-4" htmlFor="smallbags">SmallBags</label>
                        <input type='text' required id="smallbags" name="smallbags" placeholder="2" min={0} max={10}
                        className="bg-white border-2 border-gray-200 rounded w-auto p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-gray-700 pr-4" htmlFor="dayRate">Rate</label>
                        <input type='text' required id="dayRate" name="dayRate" placeholder="Daily Rate" 
                        className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
                    </div>
                    <button type="submit" className="bg-blue-500 hover:bg-blue-700 rounded text-white p-2">Add New Car</button>
                </form>
                : null
            }
        </main>
